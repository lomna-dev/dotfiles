...
#+BEGIN_SRC emacs-lisp
  ...
  (setq package-selected-packages
	'(ace-window corfu cape dashboard doom-themes god-mode ivy counsel swiper mini-modeline which-key htmlize magit))
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq dashboard-startup-banner "~/.emacs.d/loopyasiandragonframe.svg")
